...
const Footer = () => {
    return (
        <footer className="p-6 bg-gray-800 dark:bg-gray-100 text-gray-100 dark:text-gray-800">
            <div className="container grid grid-cols-2 mx-auto gap-x-3 gap-y-8 sm:grid-cols-3 md:grid-cols-4">
                <div className="flex flex-col space-y-4">
                    <h2 className="font-medium">Getting started</h2>
                    <div className="flex flex-col space-y-2 text-sm text-gray-400 dark:text-gray-600">
            ...
            <div className="flex items-center justify-center px-6 pt-12 text-sm">
                <span className="text-gray-400 dark:text-gray-600">© Copyright 1986. All Rights Reserved.</span>
            </div>
        </footer>
    );
};
