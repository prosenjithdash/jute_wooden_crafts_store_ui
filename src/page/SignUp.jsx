...
const SignUp = () => {
    ...
    const handleSignUp = async (e) => {
        ...
        try {
            ...
            // updateProfile or save user name and image
    ...
    return (
        <div className=" bg-[url('https://static.vecteezy.com/system/resources/previews/037/245/072/non_2x/ai-generated-crafts-advertisment-background-with-copy-space-free-photo.jpg')]">

            <div className="w-full  justify-center  flex items-center lg:py-[180px] py-[70px] px-4" >
                <div className="w-full max-w-md p-8 space-y-3 rounded-xl bg-gray-900 dark:bg-gray-50 text-gray-100 dark:text-gray-800">
                    ...
                    <div className="flex items-center pt-4 space-x-1">
                        ...
                        <p className="px-3 text-sm text-gray-400 dark:text-gray-600">SignUp with social accounts</p>
                        <div className="flex-1 h-px sm:w-16 bg-gray-700 dark:bg-gray-300"></div>
                    </div>
                    ...
                    <p className="text-xs text-center sm:px-6 text-gray-400 dark:text-gray-600"> Already have an account? Please
