            ...
            <div className="w-full justify-center  flex items-center lg:py-[180px] py-[70px] px-4" >
                <div className="w-full max-w-md p-8 space-y-3 rounded-xl bg-gray-900 dark:bg-gray-50 text-gray-100 dark:text-gray-800">
                    ...
                    <form
                        ...
                        <button className="block w-full p-3 text-center rounded-sm text-gray-900 dark:text-gray-50 bg-violet-400 dark:bg-violet-600">Sign in</button>
                    </form>
                    ...
                    <p className="text-xs text-center sm:px-6 text-gray-400 dark:text-gray-600">Don't have an account?
                        <a rel="noopener noreferrer" href="#" className="underline text-gray-100 dark:text-gray-800">Sign up</a>
                    </p>
                </div>
           </div>
